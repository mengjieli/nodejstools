...
class PopManager extends eui.Component {
    ...
    public pop(panel: egret.DisplayObject,center: boolean,mask: boolean): void {
        if(mask) {
    ...
    public static pop(panel: egret.DisplayObject,center:boolean=false,mask:boolean=false) :void {
