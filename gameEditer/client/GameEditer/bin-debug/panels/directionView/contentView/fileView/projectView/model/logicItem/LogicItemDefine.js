 ...
 *
 */
var LogicItemDefine = (function (_super) {
    __extends(LogicItemDefine, _super);
    function LogicItemDefine(data, itemData) {
    ...
    var d = __define,c=LogicItemDefine;p=c.prototype;
    return LogicItemDefine;
})(LogicItemBase);
egret.registerClass(LogicItemDefine,"LogicItemDefine");
