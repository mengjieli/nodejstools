 ...
 *
 */
var ModelAddLogicPanel = (function (_super) {
    __extends(ModelAddLogicPanel, _super);
    function ModelAddLogicPanel(data, logic) {
    ...
    var d = __define,c=ModelAddLogicPanel;p=c.prototype;
    p.addTitle = function () {
        var startX = 60;
        var startY = 110;
    ...
    p.addParamSprite = function (index) {
        ...
        typeDrop.addEventListener(egret.Event.CHANGE, function (e) {
        ...
        initDrop.addEventListener(egret.Event.CHANGE, function (e) {
        ...
        if (index < 0) {
            ...
            addParamBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
                if (newDesc.text == "") {
    ...
    return ModelAddLogicPanel;
})(eui.Panel);
egret.registerClass(ModelAddLogicPanel,"ModelAddLogicPanel");
