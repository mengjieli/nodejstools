    ...
    show:function( value ) {
        ...
        if (value.objectid == null) {
            if (data.moduleInit) {
                ...
                for (var i = data.buildingItemArray.length; i > 0; i--) {
                    var delayTime = 0.05;
                    var time = 0.1;
                    ...
                    data.buildingItemArray[i-1].runAction(cc.sequence(cc.DelayTime(i*delayTime), action,cc.Hide()
                        ,cc.CallFunc(function(){
                            data.buildingMenuBg.runAction(cc.Sequence(cc.scaleTo(0.1,0),cc.CallFunc(function(){
