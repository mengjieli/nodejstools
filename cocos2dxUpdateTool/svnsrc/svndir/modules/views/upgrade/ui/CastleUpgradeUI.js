...
var CastleUpgradeUI=cc.Node.extend({
    ...
    updateDemandObjectConfig:function()
    {
        ...
        var configData = ModuleMgr.inst().getData("ConfigTableUpdator").getConfigTableValueByKey("City_Castel",this._info._building_level + 1);
    ...
    updateResourceConfig:function()
    {
        ...
        var current = ModuleMgr.inst().getData("ConfigTableUpdator").getConfigTableValueByKey("City_Castel",this._info._building_level );
        var next =  ModuleMgr.inst().getData("ConfigTableUpdator").getConfigTableValueByKey("City_Castel",this._info._building_level + 1 );
