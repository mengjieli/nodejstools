...
var TowerUpgradeUI = cc.Node.extend({
    ...
    initUI:function()
    {
        this._ui = ccs.load("res/images/ui/towerUpgrade/Layer.json","res/images/ui/").node;
    ...
    updateDemandObjectConfig:function()
    {
        ...
        var configData = ModuleMgr.inst().getData("ConfigTableUpdator").getConfigTableValueByKey("City_Tower",this._info._building_level + 1);
    ...
    updateResourceConfig:function()
    {
        ...
        var current = ModuleMgr.inst().getData("ConfigTableUpdator").getConfigTableValueByKey("City_Tower",this._info._building_level );
        var next =  ModuleMgr.inst().getData("ConfigTableUpdator").getConfigTableValueByKey("City_Tower",this._info._building_level + 1 );
        if( current == null ) return;

        var currentList = [];
        var itemData = {};
        itemData.id = 0;
        itemData.value = current.atk;
        itemData.max = next == null ? "-" : ("+" + next.atk);
        ...
        for( var i = 0; i<len; i++ )
        {
            ...
            var itemUI = it.getChildByName("ico");
            itemUI.ignoreContentAdaptWithSize(true);
            itemUI.loadTexture( "res/images/ui/towerUpgrade/jt_gongjili.png" );
            itemUI = it.getChildByName("text0");
            itemUI.ignoreContentAdaptWithSize(true);
...
//        var config = {};
//        config[1] = {};
//        config[1].Need_Resource = {"1101001":50000,"1101002":20000,"1101003":20000};
//        config[1].atk = 1;
//        config[1].Need = {"1907001":0};
//        config[2] = {};
//        config[2].Need_Resource = {"1101001":50000,"1101002":20000,"1101003":20000};
//        config[2].atk = 2;
//        config[2].Need = {"1907001":2};
//        config[3] = {};
//        config[3].Need_Resource = {"1101001":50000,"1101002":20000,"1101003":20000};
//        config[3].atk = 3;
//        config[3].Need = {"1907001":2};
//        config[4] = {};
//        config[4].Need_Resource = {"1101001":50000,"1101002":20000,"1101003":20000};
//        config[4].atk = 4;
//        config[4].Need = {"1907001":2};
//
//
//        var isUpdate = true;
//        var level = 2;
...
//            {
//                conf = config[i];
//                for( var j in conf.Need_Resource )
//                {
//                    var oo = {};
//                    oo.id = j;
//                    oo.value = conf.Need_Resource[j];
//                    dataList.push( oo );
//                }
//            }
//        }
//
//        var add = isUpdate ? 2 : 1;
//        var len = dataList.length + add;
//        var item0 = this._ui.getChildByName("Panel_0");
//        item0.setVisible( false );
//        var scroll = this._ui.getChildByName("ScrollView_1");
//        scroll.removeAllChildren();
...
//            }
//
//            var configObj = dataList[index];
//            var itemUI = it.getChildByName("ico");
//            itemUI.loadTexture(ResMgr.inst()._icoPath + configObj.id + "0.png" );
//            itemUI = it.getChildByName("text0");
//            itemUI.setString( configObj.value );
//            itemUI = it.getChildByName("zt");
//            itemUI = it.getChildByName("Button");
//            itemUI.addTouchEventListener( this.speedCall, this );
//            itemUI = it.getChildByName("Button").getChildByName("Text");
...
//            scroll.addChild( it );
//            it.setVisible(true);
//            it.setPosition( 0, (size.height - itemH) - 0 * itemH );
//
//            if( 0 % 2 == 0 )
//            {
//                var b = it.getChildByName("back");
...
//            itemUI = it.getChildByName("text0");
//            itemUI.ignoreContentAdaptWithSize(true);
//            itemUI.setString( ResMgr.inst().getString( this._id + "0" ) + ResMgr.inst().getString("xiangqing_18") + " " + configObj.value );
//            itemUI = it.getChildByName("zt");
//            itemUI = it.getChildByName("Button");
//            itemUI.addTouchEventListener( this.gotoCall, this );
//            itemUI = it.getChildByName("Button").getChildByName("Text");
...
//        scroll.addChild( it );
//        it.setVisible(true);
//        var ind = isUpdate ? 1 : 0;
//        it.setPosition( 0, (size.height - itemH) - ind * itemH );
//
//        if( ind % 2 == 0 )
//        {
//            var b = it.getChildByName("back");
...
//
//        var configObj = {};
//        for( var j in conf.Need )
//        {
//            configObj.id = j;
//            configObj.value = conf.Need[j];
//        }
//        var itemUI = it.getChildByName("ico");
//        itemUI.loadTexture(ResMgr.inst()._icoPath + configObj.id + "0.png" );
//        itemUI = it.getChildByName("text0");
...
//        itemUI = it.getChildByName("zt");
//        itemUI = it.getChildByName("Button");
//        itemUI.addTouchEventListener( this.butCall, this );
//        itemUI = it.getChildByName("Button").getChildByName("Text");
//        itemUI.ignoreContentAdaptWithSize(true);
//        itemUI.setString( ResMgr.inst().getString("xiangqing_17") );
//
...
//
//        ///下一级升级需求///////////////////////////////////////////////////////////////////////////
//        var current = config[level];
//        var next =  config[level +1 ];
//        var currentList = [];
//
//        var itemData = {};
//        itemData.id = 1111;
...
//        currentList.push( itemData );
//
//        txt = this._ui.getChildByName("Text_24");
//        txt.ignoreContentAdaptWithSize( true );
//        txt.setString( ResMgr.inst().getString("shengji_2") + " " + (next == null ? "-" : (level  + 1)) );
//
...
//        scroll = this._ui.getChildByName("ScrollView_2");
//        scroll.removeAllChildren();
//        itemH = item0.getContentSize().height;
//        h = len * itemH;
//        size = scroll.getContentSize();
//        size.height = h > size.height ? h : size.height;
//        for( var i = 0; i<len; i++ )
//        {
//            var it = item0.clone();
...
//            var itemUI = it.getChildByName("ico");
//            itemUI.ignoreContentAdaptWithSize(true);
//            itemUI.loadTexture(ResMgr.inst()._icoPath + d.id + "0.png" );
//            itemUI = it.getChildByName("text0");
//            itemUI.ignoreContentAdaptWithSize(true);
//            itemUI.setString( d.value + "" );
//            itemUI = it.getChildByName("Text");
...
//        if( type == ccui.Widget.TOUCH_ENDED )
//        {
//            ModuleMgr.inst().openModule("AccelerateModule", { id:this._id, type:3 } );
//        }
//    },
//
//    gotoCall:function( node, type )
...
//        if( type == ccui.Widget.TOUCH_ENDED )
//        {
//            ModuleMgr.inst().openModule( "UpgradeModule" , node.id );
//        }
//    }
//});