    ...
    show:function( data ) {
        ...
        if (data == null) {
            if (menuData.moduleInit) {
                ...
                for (var i = menuData.tileItemArray.length; i > 0; i--) {
                    var delayTime = 0.05;
                    var time = 0.1;
                    ...
                    menuData.tileItemArray[i-1].runAction(cc.sequence(cc.DelayTime(i*delayTime), action,cc.Hide()
                        ,cc.CallFunc(function(){
                            menuData.tileMenuBg.runAction(cc.Sequence(cc.scaleTo(0.1,0),cc.CallFunc(function(){
