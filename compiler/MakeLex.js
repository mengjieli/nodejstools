...
if(lex != "")
{
    ...
    //}
    var file = "";
    file += "var moves = " + printObj(dfa.moves,"") + ";\r\n";
    file += "var start = " + dfa.start + ";\r\n";
    var befores = {};
    for(var key in dfa.endInfos)
    {
    ...
    file += "var endInfos = " + printObj(dfa.endInfos,"") + ";\r\n";

    file += "var befores = " + printObj2(befores,"") + ";\r\n";
    file += "var inputs = " + printObj(dfa.inputs,"") + ";\r\n";
    file += "global.ScannerTable = {moves:moves,endInfos:endInfos,inputs:inputs,start:start,befores:befores};"
    fs.writeFile("output/as3/core/ScannerTable.js",file);
