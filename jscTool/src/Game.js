...
var Game = function (auto) {
    ...
    function init() {
        ...
        GameSDK.DataManager.getInstance().loadDataDefine("res/data/MapCastleData.json");
        GameSDK.DataManager.getInstance().loadDataDefine("res/data/MapData.json");
        GameSDK.DataManager.getInstance().loadDataDefine("res/data/PlayerData.json");
        GameSDK.DataManager.getInstance().loadDataDefine("res/data/BagData.json");

        //zwp
        GameSDK.DataManager.getInstance().loadDataDefine("res/data/AnnouncementData.json");
        GameSDK.DataManager.getInstance().loadDataDefine("res/data/CastleData.json");
        GameSDK.DataManager.getInstance().loadDataDefine("res/data/CastleListData.json");
        GameSDK.DataManager.getInstance().loadDataDefine("res/data/CastleBlockItemData.json");
        GameSDK.DataManager.getInstance().loadDataDefine("res/data/ResourceItemData.json");
        GameSDK.DataManager.getInstance().loadDataDefine("res/data/EmailData.json");
        GameSDK.DataManager.getInstance().loadDataDefine("res/data/MailItemData.json");
    ...
    function runGame() {
        ...
        //var sp = new cc.Sprite("fight/test.jpg");
        //ModuleMgr.inst().addNodeTOLayer(sp, ModuleLayer.LAYER_TYPE_TOP);
    }
    ...
    function registerLoadingAndLoginingModule() {
        ...
        registerModuleAndData("Logining", {
            className: "LoginingModule",
            layer: ModuleLayer.LAYER_TYPE_UI
        }, null, ["res/loadingAndLogining/loginingUI.json"]);
