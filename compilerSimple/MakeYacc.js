...
var content = "";
content += "package flower.binding.compiler\n";
content += "{\n";
content += "\tpublic class ParserTable\n";
content += "\t{\n";
content += "\tpublic static var action:Object = " + printObj(dfa.action) + ";\n";
content += "\tpublic static var go:Object = " + printObj(dfa.goto) + ";\n";
content += "\t}\n";
content += "}";
//content += "global.ParserTable = {\"action\":action,\"goto\":goto};\r\n";
fs.writeFile("output/as3/core/ParserTable.as",content);
